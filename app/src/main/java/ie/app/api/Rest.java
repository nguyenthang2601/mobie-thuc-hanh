...
private static final String hostURL = "http://192.168.56.1:3000/api/donation";
//	private static final String LocalhostURL = "http://192.168.0.13:3000";
	...
	public static String get(String url) {
		...
		try {
			...
			Log.v("donate", "GET REQUEST is : " +reader);
			Log.v("donate", "GET REQUEST is : " + stringBuilder);
            String line = null;
	...
	public static String delete(String url) {
		...
		Log.v("donate", "JSON DELETE URL : " + url);
		try {
			setup(url);
