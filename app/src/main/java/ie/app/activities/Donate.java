...
public class Donate extends Base {
    ...
    public void donateButtonPressed (View view)
    {
        ...
        if (donatedAmount == 0)
        {
            ...
            if (!text.equals(""))
                if(Integer.parseInt(text) < 20000) donatedAmount = Integer.parseInt(text);
                else {
    ...
    public void reset(MenuItem item)
    {
        app.donations.clear();
        app.totalDonated = 0;
        new ResetTask(this).execute("/");
//        Log.v("donate", "ERROR : " + restALl);
//        if(restALl == "OK") {
            amountTotal.setText("$" + app.totalDonated);
            progressBar.setProgress(app.totalDonated);
//        }
    ...
    private class InsertTask extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... params) {
            Log.v("donate", "Donation App Inserting: " + params[0]);
            Log.v("donate", "Donation App Inserting: 1111" + params[1]);
                Log.v("donate", "Donation App Inserting");
                String result = DonationApi.insert((String) params[0], (Donation) params[1]);
                this.dialog.dismiss();
                return result ;
        }
    ...
    private class ResetTask extends AsyncTask<Object, Void, String> {
        ...
        @Override
        protected String doInBackground(Object... params) {
            Log.v("delete donation","body : " + params[0]);
